...
D(x)] + \mathbb{E}_{z \sim p_{z}(z)} [\log (1-D(G(z)))]$ \cite{goodfellow2014generative}. Dabei wird davon ausgegangen, dass der
...
Critic sorgt für bessere Ergebnisse \cite{arjovsky_wasserstein_2017}.
...
verwendet \cite{arjovsky2017wasserstein}.
 ...
 \subsection{SNDCGAN: Anpassung von Parametern} % Jonathan
